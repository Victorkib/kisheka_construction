  ...
  if (!data || !data.productivity) {
    return (
      <div className="ds-bg-surface-muted border ds-border-subtle rounded-lg p-8 text-center">
        <p className="ds-text-secondary">No productivity data available</p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-blue-50 border border-blue-400/60 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-sm font-medium ds-text-secondary">Avg Quality Rating</p>
          </div>
        ...
        <div className="bg-green-50 border border-green-400/60 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-sm font-medium ds-text-secondary">Avg Productivity</p>
          </div>
        ...
        <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-sm font-medium ds-text-secondary">Cost per Hour</p>
          </div>
      ...
      <div className="ds-bg-surface rounded-lg shadow">
        <div className="px-4 py-3 border-b ds-border-subtle">
          <h3 className="text-lg font-semibold ds-text-primary">Productivity Breakdown</h3>
        </div>
                  ...
                  <tr key={index} className="hover:ds-bg-surface-muted">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm ds-text-secondary w-8 text-right">
      ...
      {data.groupBy === 'worker' && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-green-50 border border-green-400/60 rounded-lg p-4">
            <h4 className="text-sm font-semibold ds-text-primary mb-3">Top Quality Workers</h4>
              ...
              {productivity
                ...
                .map((item, index) => (
                  <div key={index} className="flex items-center justify-between text-sm">
                    <span className="ds-text-secondary">{item.workerName}</span>
          ...
          <div className="bg-blue-50 border border-blue-400/60 rounded-lg p-4">
            <h4 className="text-sm font-semibold ds-text-primary mb-3">Top Productivity Workers</h4>
            <div className="space-y-2">
              {productivity
                .sort(
                  (a, b) =>
