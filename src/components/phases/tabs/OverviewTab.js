...
export function OverviewTab({ phase, project, canEdit, onStatusChange, onCompletionChange, updatingStatus, updatingCompletion, formatDate, formatCurrency, getStatusColor }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="ds-bg-surface border ds-border-accent-subtle rounded-lg p-6">
        <div className="flex items-center justify-between">
          ...
          <Link
            ...
            className="ds-bg-accent-primary hover:ds-bg-accent-hover text-white font-medium px-6 py-2 rounded-lg transition-colors flex items-center gap-2"
          >
