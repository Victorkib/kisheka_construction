    ...
    <div className="space-y-6">
      ...
      <div className="ds-bg-surface rounded-lg shadow">
        ...
        {loading ? (
          <div className="p-12 text-center">
            <p className="ds-text-muted">Loading materials...</p>
          </div>
        ) : filteredMaterials.length === 0 ? (
          <div className="p-12 text-center">
            <p className="ds-text-muted mb-4">No materials found</p>
            <Link
              href={`/items/new?projectId=${phase.projectId}&phaseId=${phase._id}&entryType=retroactive_entry`}
      ...
      <div className="ds-bg-surface rounded-lg shadow p-6">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-semibold ds-text-primary">Material Requests</h3>
          <Link
      ...
      <div className="ds-bg-surface rounded-lg shadow p-6">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-semibold ds-text-primary">Purchase Orders</h3>
          <Link
