...
export function RegisterForm() {
  ...
  if (loadingInvitation) {
    return (
      <div className="text-center py-8">
        ...
        <p className="mt-2 text-sm ds-text-muted">Verifying invitation...</p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      {invitation && (
        <div className="bg-blue-500/10 border border-blue-400/60/70 text-blue-100 px-4 py-3 rounded text-sm">
      ...
      <div className="grid grid-cols-2 gap-2">
        <div>
          <label htmlFor="firstName" className="block text-sm font-medium ds-text-secondary mb-1">
            First Name
          </label>
          <input
            id="firstName"
        ...
        <div>
          <label htmlFor="lastName" className="block text-sm font-medium ds-text-secondary mb-1">
            Last Name
          </label>
          <input
            id="lastName"
      ...
      <div>
        ...
        />
        {invitation && (
          <p className="text-xs ds-text-muted mt-1">Email is pre-filled from your invitation</p>
        )}
      </div>
