...
export function LoadingSkeleton({ 
  ...
  const renderSkeleton = () => {
    switch (type) {
      ...
      case 'table':
        return (
          <div className={`ds-bg-surface rounded-lg shadow overflow-hidden ${className}`}>
            <div className="animate-pulse">
              ...
              <div className="ds-bg-surface-muted px-6 py-3 border-b ds-border-subtle">
                <div className="flex space-x-4">
                  ...
                  <div className="h-4 ds-bg-surface-muted rounded w-28"></div>
                  <div className="h-4 ds-bg-surface-muted rounded w-20"></div>
                </div>
              </div>
              {/* Table Rows */}
              {Array.from({ length: props.rows || 5 }).map((_, i) => (
                <div key={i} className="px-6 py-4 border-b ds-border-subtle">
                  <div className="flex space-x-4">
                    <div className="h-4 ds-bg-surface-muted rounded w-24"></div>
                    <div className="h-4 ds-bg-surface-muted rounded w-32"></div>
                    <div className="h-4 ds-bg-surface-muted rounded w-28"></div>
      ...
      case 'image':
        return (
          <div
            className={`ds-bg-surface-muted rounded animate-pulse ${className}`}
            style={{
      ...
      default:
        return (
          <div className={`h-4 ds-bg-surface-muted rounded animate-pulse ${className}`}></div>
        );
    }
  };
