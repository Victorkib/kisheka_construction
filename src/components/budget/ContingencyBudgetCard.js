...
export function ContingencyBudgetCard({ projectId }) {
  ...
  if (loading) {
    return (
      <div className="ds-bg-surface rounded-lg shadow p-6 border-2 border-orange-200">
  ...
  if (!data || data.budgeted === 0) {
    return (
      <div className="ds-bg-surface rounded-lg shadow p-6 border-2 border-orange-200">
        ...
        <p className="text-sm ds-text-secondary">Contingency reserve not set. Please set a project budget first.</p>
      </div>
    );
  }
  ...
  return (
    <div className="ds-bg-surface rounded-lg shadow p-6 border-2 border-orange-200">
      ...
      <div className="grid grid-cols-3 gap-4 mb-4">
        ...
        <div>
          <p className="text-xs ds-text-secondary mb-1">Used</p>
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm ds-text-secondary">Usage</span>
        ...
        {expanded && (
          <div className="mt-4 space-y-3">
            {Object.entries(byType).map(([type, amount]) => {
              ...
              return (
                <div key={type} className="ds-bg-surface-muted rounded-lg p-3">
                  <div className="flex items-center justify-between mb-2">
      ...
      <div className="mt-4 pt-4 border-t flex gap-2">
        ...
        <Link
          ...
          className="flex-1 text-center px-4 py-2 ds-bg-surface-muted hover:ds-bg-surface-muted ds-text-secondary text-sm font-medium rounded-lg transition"
        >
          View History
        </Link>
      </div>
...
function ContingencyDrawForm({ projectId, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="ds-bg-surface rounded-lg shadow-xl p-6 max-w-md w-full mx-4">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold ds-text-primary">Request Contingency Draw</h3>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <select
              ...
              required
              className="w-full px-3 py-2 ds-bg-surface ds-text-primary border ds-border-subtle rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500"
            >
          ...
          <div>
            ...
            <input
              ...
              step="0.01"
              required
              className={`w-full px-3 py-2 ds-bg-surface ds-text-primary border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 ${
          ...
          <div className="flex gap-2 pt-4">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 px-4 py-2 border ds-border-subtle rounded-lg hover:ds-bg-surface-muted transition"
            >
              Cancel
            </button>
            <button
