      ...
      {suggestedAmount && feeType && (
        <div className="rounded-lg border border-green-400/60 bg-gradient-to-br from-green-50 to-emerald-50 p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-base font-semibold ds-text-primary">Suggested Fee Amount</h3>
          </div>

          <div className="ds-bg-surface/70 rounded-lg p-4 border border-green-400/60 mb-3">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium ds-text-secondary">Based on {feeType.replace(/_/g, ' ').replace(/\b\w/g, l => l.toUpperCase())}</span>
