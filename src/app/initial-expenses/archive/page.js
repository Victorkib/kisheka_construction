      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          ...
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl md:text-3xl font-bold ds-text-primary">Archived Initial Expenses</h1>
        ...
        {expenses.length === 0 ? (
          <div className="ds-bg-surface rounded-lg shadow p-12 text-center">
            ...
            <h3 className="mt-2 text-sm font-medium ds-text-primary">No archived initial expenses</h3>
            <p className="mt-1 text-sm ds-text-muted">There are no archived initial expenses at this time.</p>
          </div>
        ) : (
      ...
      <AppLayout>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center py-12">
            <LoadingSpinner />
            <p className="mt-4 ds-text-secondary">Loading archived initial expenses...</p>
          </div>
        </div>
      </AppLayout>
    }>
