  ...
  return (
    <AppLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Information Card */}
        <div className="bg-gradient-to-br from-purple-50 via-violet-50 to-purple-100 rounded-xl border-2 border-purple-400/60 p-4 sm:p-5 mb-6 shadow-lg transition-all duration-300">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between gap-2 mb-1">
                ...
                <button
                  ...
                  className="flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 ds-bg-surface/80 hover:ds-bg-surface border border-purple-400/60 rounded-lg flex items-center justify-center shadow-sm hover:shadow-md transition-all duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
          ...
          <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl shadow-lg border border-purple-400/60 p-6 hover:shadow-xl transition-shadow duration-200">
