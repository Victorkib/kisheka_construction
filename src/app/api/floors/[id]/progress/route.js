...
export async function DELETE(request, { params }) {
  try {
    ...
    if (photoIndex === null || isNaN(parseInt(photoIndex))) {
      return errorResponse('Photo index is required', 400);
    }
    ...
    if (index < 0 || index >= photos.length) {
      return errorResponse('Invalid photo index', 400);
    }
    ...
    return errorResponse('Failed to delete floor photo', 500);
  }
}