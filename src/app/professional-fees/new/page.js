...
function NewProfessionalFeePageContent() {
  ...
  } = useProfessionalPrerequisites('fees', currentProjectId);
    ...
    return (
      <AppLayout>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <Link href="/professional-fees" className="text-blue-400 hover:text-blue-300 underline">
            ← Back to Fees
          </Link>
        </div>
      </AppLayout>
  ...
  if (!prereqLoading && !canProceed) {
    return (
      <AppLayout>
        <PrerequisiteBlock
          title="Cannot Create Fee"
          description="You need active professional assignments before creating fees."
          ...
          actions={[
            ...
            { href: '/professional-fees', label: 'Back to Fees', icon: '←' },
          ]}
  ...
  return (
    <AppLayout>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header */}
        <div className="mb-8">
          <Link href="/professional-fees" className="text-blue-400 hover:text-blue-300 text-sm mb-4 inline-block">
            ← Back to Fees
          </Link>
          <h1 className="text-2xl md:text-3xl font-bold ds-text-primary leading-tight">
            Create Professional Fee
          </h1>
          <p className="ds-text-secondary mt-2">Create a new professional fee entry</p>
        </div>
