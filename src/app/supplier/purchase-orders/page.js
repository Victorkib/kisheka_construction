          ...
          <div className="flex items-start">
            ...
            <div className="ml-3 flex-1">
              <h3 className="text-lg font-medium text-yellow-800 mb-2">
                Supplier Purchase Orders Page No Longer Available
              </h3>
              <div className="text-sm text-yellow-700 space-y-2">
                ...
                <p>
                  <strong>How to view and respond to purchase orders:</strong>
                </p>
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>You will receive purchase orders via email, SMS, or push notification</li>
                  <li>Each notification includes a secure link to view and respond to the order</li>
                  <li>Click the link in the email/SMS to access the order details</li>
                  <li>You can accept, reject, or request modifications directly from the response page</li>
