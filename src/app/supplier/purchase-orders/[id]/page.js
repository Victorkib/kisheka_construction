          ...
          <div className="flex items-start">
            ...
            <div className="ml-3 flex-1">
              <h3 className="text-lg font-medium text-yellow-800 mb-2">
                Supplier Purchase Order Detail Page No Longer Available
              </h3>
              <div className="text-sm text-yellow-700 space-y-2">
                ...
                <p>
                  <strong>To view and respond to purchase orders:</strong>
                </p>
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>Check your email or SMS for purchase order notifications</li>
                  <li>Click the secure link provided in the notification</li>
                  <li>You will be taken to a response page where you can view order details and respond</li>
