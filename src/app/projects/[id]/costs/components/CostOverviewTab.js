...
export function CostOverviewTab({ projectId }) {
  ...
  return (
    <div className="space-y-6">
      {/* Overall Status */}
      <div className="ds-bg-surface rounded-lg shadow p-4 sm:p-6 border-2 ds-border-subtle">
        <h2 className="text-lg sm:text-xl font-bold ds-text-primary mb-3 sm:mb-4">Overall Budget Status</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          <div className="p-3 sm:p-4 ds-bg-surface-muted rounded-lg">
            <p className="text-xs sm:text-sm ds-text-secondary mb-1">Total Budget</p>
            <p className="text-xl sm:text-2xl font-bold ds-text-primary break-words">{formatCurrency(budget.total || 0)}</p>
          </div>
          <div className="p-3 sm:p-4 ds-bg-surface-muted rounded-lg">
            <p className="text-xs sm:text-sm ds-text-secondary mb-1">Total Spent</p>
            <p className="text-xl sm:text-2xl font-bold ds-text-primary break-words">
              {formatCurrency(financialOverview?.financing?.totalUsed || 0)}
            </p>
          </div>
          <div className="p-3 sm:p-4 ds-bg-surface-muted rounded-lg">
            <p className="text-xs sm:text-sm ds-text-secondary mb-1">Remaining</p>
            <p className="text-xl sm:text-2xl font-bold ds-text-primary break-words">{formatCurrency(budget.remaining || 0)}</p>
          </div>
          <div className="p-3 sm:p-4 ds-bg-surface-muted rounded-lg">
            <p className="text-xs sm:text-sm ds-text-secondary mb-1">Status</p>
            <span
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        {/* DCC Card */}
        <div className="ds-bg-surface rounded-lg shadow p-4 sm:p-6 border-2 ds-border-subtle hover:border-blue-400/60 transition">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3 sm:mb-4 gap-2">
            <h3 className="text-base sm:text-lg font-semibold ds-text-primary flex items-center gap-2">
          ...
          <div className="space-y-2 sm:space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-xs sm:text-sm ds-text-secondary">Budgeted</span>
              <span className="text-xs sm:text-sm font-semibold ds-text-primary break-words text-right ml-2">{formatCurrency(dccBudget)}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-xs sm:text-sm ds-text-secondary">Spent</span>
              <span className="text-xs sm:text-sm font-semibold ds-text-primary break-words text-right ml-2">{formatCurrency(dccSpent)}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-xs sm:text-sm ds-text-secondary">Remaining</span>
              <span className="text-xs sm:text-sm font-semibold ds-text-primary break-words text-right ml-2">{formatCurrency(dccRemaining)}</span>
            </div>
      ...
      <div className="ds-bg-surface rounded-lg shadow p-4 sm:p-6 border-2 ds-border-subtle">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          ...
          >
            ...
            <div className="text-sm sm:text-base font-semibold ds-text-primary">Request Budget Transfer</div>
            <div className="text-xs sm:text-sm ds-text-secondary mt-1">Move funds between categories</div>
          </Link>
          <Link
          ...
          >
            <div className="text-xl sm:text-2xl mb-2">📝</div>
            <div className="text-sm sm:text-base font-semibold ds-text-primary">Request Budget Adjustment</div>
            <div className="text-xs sm:text-sm ds-text-secondary mt-1">Increase or decrease budgets</div>
          </Link>
          <Link
          ...
          >
            <div className="text-xl sm:text-2xl mb-2">📄</div>
            <div className="text-sm sm:text-base font-semibold ds-text-primary">Generate Report</div>
            <div className="text-xs sm:text-sm ds-text-secondary mt-1">Create financial reports</div>
          </Link>
        </div>
      </div>
    </div>
