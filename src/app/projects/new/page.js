        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="ds-bg-surface rounded-xl shadow-lg border ds-border-subtle overflow-hidden">
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-4 border-b ds-border-subtle">
            ...
            <div className="ds-bg-surface rounded-xl shadow-lg border ds-border-subtle overflow-hidden">
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 px-6 py-4 border-b ds-border-subtle">
                <div className="flex items-center gap-3">
            ...
            {/* Section 3: Budget */}
            <div className="ds-bg-surface rounded-xl shadow-lg border ds-border-subtle overflow-hidden">
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 px-6 py-4 border-b ds-border-subtle">
                <div className="flex items-center gap-3">
                    ...
                    >
                      <div className="flex items-center gap-2 mb-1">
                        <span className={`inline-flex h-5 w-5 items-center justify-center rounded-full text-xs font-bold ${
                          budgetMode === 'later' ? 'bg-blue-600 text-white' : 'ds-bg-surface-muted ds-text-secondary'
                        }`}>
                          1
                        </span>
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <div className="bg-slate-700/50 rounded p-2 mt-2 border border-slate-600">
            ...
            <div className="ds-bg-surface rounded-xl shadow-lg border ds-border-subtle overflow-hidden">
              <div className="bg-gradient-to-r from-orange-50 to-amber-50 px-6 py-4 border-b ds-border-subtle">
                <div className="flex items-center gap-3">
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="px-4 py-3 bg-gradient-to-r from-gray-50 to-gray-100 border ds-border-subtle rounded-lg">
                      <div className="flex items-start gap-3">
