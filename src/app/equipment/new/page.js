        ...
        <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-200">
            ...
            <LoadingButton
              ...
              loading={saving}
              className="flex-1 px-6 py-2.5 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-bold rounded-lg transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed touch-manipulation"
            >
              Create Equipment
            </LoadingButton>
          </div>
