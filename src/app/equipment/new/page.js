      ...
      <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-2.5 bg-white text-gray-900 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 placeholder:text-gray-400 transition-all duration-200 font-medium resize-none"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-4">
            <Link 
              href="/equipment"
              className="flex-1 px-6 py-3 bg-gray-200 hover:bg-gray-300 text-gray-900 font-bold rounded-lg transition-all duration-200 text-center"
            >
              Cancel
            </Link>
            <LoadingButton
              ...
              loading={saving}
              className="flex-1 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Create Equipment
            </LoadingButton>
          </div>
