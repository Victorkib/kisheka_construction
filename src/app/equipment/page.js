      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6 sm:mb-8 flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">
          <div className="flex-1 min-w-0">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">Equipment</h1>
            <p className="text-sm sm:text-base text-gray-600 mt-1">Manage equipment assignments and tracking</p>
          </div>
          <Link
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="hidden md:block bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
              ...
              {/* Desktop Pagination */}
              {pagination.pages > 1 && (
                <div className="bg-gray-50 px-4 sm:px-6 py-4 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-3">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="px-4 py-2 border-2 border-gray-300 rounded-lg text-gray-900 font-semibold hover:bg-gray-50 active:bg-gray-100 hover:border-gray-400 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 touch-manipulation"
                    >
                      Previous
                    </button>
              ...
              {equipment.map((eq) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-3 pb-3 border-b border-gray-200">
                    <div>
                      <p className="text-xs text-gray-500 mb-0.5">Acquisition</p>
